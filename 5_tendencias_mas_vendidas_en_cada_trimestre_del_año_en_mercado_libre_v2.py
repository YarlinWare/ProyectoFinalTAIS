...
for rango_fecha in rangos_fechas:
    ...
    for categoria in categorias:
        ...
        url_productos = f'https://api.mercadolibre.com/sites/MLA/search?category={categoria_id}&sort=sold_quantity_desc&limit=1&buying_mode=buy_it_now&currency=ARS&date_from={fecha_desde}T00:00:00.000-00:00&date_to={fecha_hasta}T23:59:59.999-00:00&access_token={token}'
        response = requests.get(url_productos)
        data = response.json()
        
        cantidad_vendida = data['paging']['total']
