...
# Obtendremos la lista de categorías de mercado libre para iterar los productos tecnologícos
...
if response.status_code == 200:
    ...
    print(f"Error al obtener la lista de categorías: {response.status_code}")

# Creamos la lista y definomos los años
        ...
        if productos is not None:
            for item in productos["results"][:15]:
                resultado = {
                    ...
                    "ventas": item["sold_quantity"],
                    "url": item["permalink"]
                }
                resultados.append(resultado)

df = pd.DataFrame(resultados)
df.to_csv("productos_mas_vendidos.csv", index=False)
